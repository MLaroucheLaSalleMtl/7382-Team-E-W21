...
public class PlayerInput : MonoBehaviour
{
    ...
    {
		//Vector2 look_dir = Mouse_pos - Rb_player.position;
		if (weapon_name=="Pistol"&Input.GetKeyDown(KeyCode.Mouse0))
        {
		...
		else if(weapon_name=="Shotgun"&Input.GetKeyDown(KeyCode.Mouse0))
        {
		...
		else if(weapon_name=="AR"&Input.GetKey(KeyCode.Mouse0))
        {
		...
		else if (weapon_name=="SniperR" & Input.GetKeyDown(KeyCode.Mouse0))
        {
